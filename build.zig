...
pub fn build(b: *std.Build) void {
    ...
    const error_bar_chart_tests = b.addTest(.{
        .name = "error_bar_chart_tests",
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/error_bar_chart_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    error_bar_chart_tests.root_module.addImport("sailor", sailor_module_for_tests);
    test_step.dependOn(&b.addRunArtifact(error_bar_chart_tests).step);

    const donut_chart_tests = b.addTest(.{
        .name = "donut_chart_tests",
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/donut_chart_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    donut_chart_tests.root_module.addImport("sailor", sailor_module_for_tests);
    test_step.dependOn(&b.addRunArtifact(donut_chart_tests).step);
    ...
    const pareto_chart_tests = b.addTest(.{
        .name = "pareto_chart_tests",
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/pareto_chart_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const ridgeline_plot_tests = b.addTest(.{
        .name = "ridgeline_plot_tests",
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/ridgeline_plot_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ridgeline_plot_tests.root_module.addImport("sailor", sailor_module_for_tests);
    test_step.dependOn(&b.addRunArtifact(ridgeline_plot_tests).step);

    const bump_chart_tests = b.addTest(.{
        .name = "bump_chart_tests",
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/bump_chart_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const core_coverage_audit_tests = b.addTest(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/core_coverage_audit.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
