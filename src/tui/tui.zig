...
pub const ansi_art = @import("ansi_art.zig");
...
pub const widgets = struct {
    ...
    pub const ColorPickerMode = @import("widgets/color_picker.zig").ColorPickerMode;
    pub const RgbComponent = @import("widgets/color_picker.zig").RgbComponent;
